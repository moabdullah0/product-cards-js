      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        {typeof window !== 'undefined' && [...Array(6)].map((_, i) => (
          <motion.div
            ...
            initial={{ 
              x: typeof window !== 'undefined' ? Math.random() * (window.innerWidth * 0.8) + (window.innerWidth * 0.1) : 0, 
              y: typeof window !== 'undefined' ? Math.random() * (window.innerHeight * 0.8) + (window.innerHeight * 0.1) : 0
            }}
            animate={{ 
              x: typeof window !== 'undefined' ? [null, Math.random() * (window.innerWidth * 0.8) + (window.innerWidth * 0.1)] : 0,
              y: typeof window !== 'undefined' ? [null, Math.random() * (window.innerHeight * 0.8) + (window.innerHeight * 0.1)] : 0,
            }}
            transition={{
